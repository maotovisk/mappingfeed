...
namespace MappingFeed.Common.Data.Enums;
...
public static class FeedEnumExtensions
{
        ...
        string? serializedGroupIds)
    {
        ...
        {
            FeedType.Map =>
                $"rulesets: {FormatRulesetsForDisplay(serializedRulesets)}, event types: {FormatEventTypesForDisplay(serializedEventTypes)}",
            FeedType.Group =>
                $"group ids: {FormatGroupIdsForDisplay(serializedGroupIds)}",
            _ => "default",
        };
    }
}
